...
public class OrderHistoryView extends JPanel{
	...
	public OrderHistoryView(int x,int y, int width, int height) {
		// separate 2 windows ?????? 
        ...
        String columns[] = {"DateTime","Runner ID","Customer ID","Food ID","Food Name", "Food Cost","Total"};
...
//		jpanel1.setBackground(Color.YELLOW);
		...
		jpanel2.setBounds(0,0,WIDTH,50);
                ...
                JLabel notificationlabel = new JLabel("Order History:");
