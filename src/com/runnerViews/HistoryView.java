...
import com.runnerdao.ViewHistoryDao;
...
public class HistoryView extends JPanel{
	...
	int HEIGHT = 150;
        ...
        String columns[] = {"Order ID","Runner ID", "Cost", "Status"};
        JTable tasktable = null;
        JScrollPane jscrollpane;
        DefaultTableModel model;
        TableColumnModel columnModel;
        ViewHistoryDao viewhistory= new ViewHistoryDao(); 
        Style style = new Style();
        
	public HistoryView(int x,int y, int width, int height) {
		// separate 2 windows ?????? 
		...
		jpanel1.setBackground(Color.YELLOW);
                ...
                JLabel historybutton = new JLabel("History");
		historybutton.setFont(style.title);
