            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if ((Id + Name + Pwd + Phoneno).equals("") || cmbgender.getSelectedIndex() + cmblocation.getSelectedIndex() == 0) {
                    ...
                    if (existID == -1) {
                        ...
                        JOptionPane.showMessageDialog(null, Id + " Existed", "Customer", JOptionPane.WARNING_MESSAGE);
                    }
        ...
        readcusbutton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (jtextfieldid.getText().equals("")) {
                    ...
                    int existID = customerfunc.checkCustomer(id);
                    if (existID == -1) {
                        JOptionPane.showMessageDialog(null, "Invalid: " + id, "Customer", JOptionPane.WARNING_MESSAGE);
                    } else {
                        model = Tools.addDataTable(customerfunc.findDataByID(id), model);
                    }
                }
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if ((Id + Name + Pwd + Phoneno).equals("") || cmbgender.getSelectedIndex() + cmblocation.getSelectedIndex() == 0) {
                    ...
                    if (existID != -1) {
                        ...
                        JOptionPane.showMessageDialog(null, Id + " Not Exist", "Customer", JOptionPane.WARNING_MESSAGE);
                    }
